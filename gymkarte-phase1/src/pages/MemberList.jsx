...
import { Search, UserPlus, AlertTriangle, X } from 'lucide-react'
    ...
    <div className="p-8">
      ...
      <div className="overflow-hidden rounded-xl border border-navy-700">
        <table className="w-full text-sm">
          ...
          <tbody>
            {results.length === 0 && (
              <tr><td colSpan={6} className="px-4 py-10 text-center text-gray-500">該当する会員がいません</td></tr>
            )}
            {results.map(({ member: m, parts }) => {
              ...
              return (
                <tr
                  ...
                  className="cursor-pointer border-t border-navy-700 hover:bg-navy-800"
                >
